...
class Settings(object):
    ...
    def __init__(self):
        ...
        self.CUSTOM_SUCCESS_RESPONSE_VIEW = lambda request, message, user_persona, access_token, redirect_url, status: render(
            request, 
            'django_auth_adfs/login_success.html', 
            {'message': message,'user_persona':user_persona,'access_token':access_token, 'redirect_url':redirect_url}, 
            status=status
        )
        self.PROXIES = None
