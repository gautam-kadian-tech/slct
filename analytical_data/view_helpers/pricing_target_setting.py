# -*- coding: utf-8 -*-
"""
Created on Thu Jul 21 12:11:08 2022
...
import numpy as np
from .pricing_static import market_pos, market_luc, market_growth, org_brand_map
import pandas as pd
...
def get_market_strategy(df, market_share, this_month, this_year):
    ...
    prev_market_share = market_share.loc[(market_share.Month.dt.month < this_month) &
